...
var G__50652 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__50652;
continue;
} else {
return ch;
...
var vec__50656 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__50656,(0),null);
return (match === s);
});
...
var len__43720__auto___50661 = arguments.length;
var i__43721__auto___50662 = (0);
while(true){
if((i__43721__auto___50662 < len__43720__auto___50661)){
args__43727__auto__.push((arguments[i__43721__auto___50662]));

var G__50663 = (i__43721__auto___50662 + (1));
i__43721__auto___50662 = G__50663;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43728__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq50659){
var G__50660 = cljs.core.first.call(null,seq50659);
var seq50659__$1 = cljs.core.next.call(null,seq50659);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__50660,seq50659__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__50664__delegate = function (rdr,_){
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,msg);
};
var G__50664 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__50665__i = 0, G__50665__a = new Array(arguments.length -  1);
while (G__50665__i < G__50665__a.length) {G__50665__a[G__50665__i] = arguments[G__50665__i + 1]; ++G__50665__i;}
  _ = new cljs.core.IndexedSeq(G__50665__a,0);
} 
return G__50664__delegate.call(this,rdr,_);};
G__50664.cljs$lang$maxFixedArity = 1;
G__50664.cljs$lang$applyTo = (function (arglist__50666){
var rdr = cljs.core.first(arglist__50666);
var _ = cljs.core.rest(arglist__50666);
return G__50664__delegate(rdr,_);
});
