...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__43251__auto__,writer__43252__auto__,opt__43253__auto__){
return cljs.core._write.call(null,writer__43252__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__50986 = o;
(G__50986[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__50987__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__50987 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50988__i = 0, G__50988__a = new Array(arguments.length -  0);
while (G__50988__i < G__50988__a.length) {G__50988__a[G__50988__i] = arguments[G__50988__i + 0]; ++G__50988__i;}
  args = new cljs.core.IndexedSeq(G__50988__a,0);
} 
return G__50987__delegate.call(this,args);};
G__50987.cljs$lang$maxFixedArity = 0;
G__50987.cljs$lang$applyTo = (function (arglist__50989){
var args = cljs.core.seq(arglist__50989);
return G__50987__delegate(args);
});
G__50987.cljs$core$IFn$_invoke$arity$variadic = G__50987__delegate;
return G__50987;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__42633__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__42633__auto__){
var and__42633__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__50995 = jsprops;
(G__50995["defaultValue"] = value);

(G__50995["onChange"] = ((function (G__50995,v,value,on_change){
return (function (p1__50992_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__50992_SHARP_);
});})(G__50995,v,value,on_change))
);

(G__50995["ref"] = ((function (G__50995,v,value,on_change){
return (function (p1__50993_SHARP_){
return (this$["cljsInputElement"] = p1__50993_SHARP_);
});})(G__50995,v,value,on_change))
);
...
var vec__51002 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__51002,(0),null);
var id = cljs.core.nth.call(null,vec__51002,(1),null);
var class$ = cljs.core.nth.call(null,vec__51002,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___51007 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___51007 == null)){
} else {
var key_51008 = temp__4661__auto___51007;
(jsprops["key"] = key_51008);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__51010 = (new reagent.impl.template.NativeWrapper());
(G__51010["name"] = c);
...
var len__43720__auto___51016 = arguments.length;
var i__43721__auto___51017 = (0);
while(true){
if((i__43721__auto___51017 < len__43720__auto___51016)){
args__43727__auto__.push((arguments[i__43721__auto___51017]));

var G__51018 = (i__43721__auto___51017 + (1));
i__43721__auto___51017 = G__51018;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43728__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51014){
var G__51015 = cljs.core.first.call(null,seq51014);
var seq51014__$1 = cljs.core.next.call(null,seq51014);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__51015,seq51014__$1);
});
...
break;
default:
var G__51022 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__51022;
continue;
...
var n__43560__auto___51025 = a.length;
var i_51026 = (0);
while(true){
if((i_51026 < n__43560__auto___51025)){
(a[i_51026] = reagent.impl.template.as_element.call(null,(a[i_51026])));

var G__51027 = (i_51026 + (1));
i_51026 = G__51027;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__43560__auto___51028 = a.length;
var i_51029 = (0);
while(true){
if((i_51029 < n__43560__auto___51028)){
var val_51030 = (a[i_51029]);
if((cljs.core.vector_QMARK_.call(null,val_51030)) && ((reagent.impl.template.key_from_vec.call(null,val_51030) == null))){
(o["no-key"] = true);
} else {
}

(a[i_51029] = reagent.impl.template.as_element.call(null,val_51030));

var G__51031 = (i_51029 + (1));
i_51029 = G__51031;
continue;
} else {
}
...
var ctx = ({});
var vec__51035 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__51035,(0),null);
var derefed = cljs.core.nth.call(null,vec__51035,(1),null);
...
var G__51039 = (cljs.core.count.call(null,argv) - first_child);
switch (G__51039) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__51039){
