...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7020__auto__,writer__7021__auto__,opt__7022__auto__){
return cljs.core._write(writer__7021__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13912 = o;
(G__13912[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13913__delegate = function (args){
...
return G__13913__delegate.call(this,args);};
G__13913.cljs$lang$maxFixedArity = 0;
G__13913.cljs$lang$applyTo = (function (arglist__13915){
var args = cljs.core.seq(arglist__13915);
return G__13913__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6402__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__6402__auto__){
var and__6402__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13921 = jsprops;
(G__13921["defaultValue"] = value);

(G__13921["onChange"] = ((function (G__13921,v,value,on_change){
return (function (p1__13918_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13918_SHARP_);
});})(G__13921,v,value,on_change))
);

(G__13921["ref"] = ((function (G__13921,v,value,on_change){
return (function (p1__13919_SHARP_){
return (this$["cljsInputElement"] = p1__13919_SHARP_);
});})(G__13921,v,value,on_change))
);
...
var vec__13928 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13928,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13928,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13928,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13933 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13933 == null)){
} else {
var key_13934 = temp__4661__auto___13933;
(jsprops["key"] = key_13934);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13936 = (new reagent.impl.template.NativeWrapper());
(G__13936["name"] = c);
...
var G__13938 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13938) : reagent.impl.template.as_element.call(null,G__13938));
} else {
...
var len__7489__auto___13944 = arguments.length;
var i__7490__auto___13945 = (0);
while(true){
if((i__7490__auto___13945 < len__7489__auto___13944)){
args__7496__auto__.push((arguments[i__7490__auto___13945]));

var G__13946 = (i__7490__auto___13945 + (1));
i__7490__auto___13945 = G__13946;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7497__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13942){
var G__13943 = cljs.core.first(seq13942);
var seq13942__$1 = cljs.core.next(seq13942);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13943,seq13942__$1);
});
...
break;
default:
var G__13950 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13950;
continue;
...
var n__7329__auto___13953 = a.length;
var i_13954 = (0);
while(true){
if((i_13954 < n__7329__auto___13953)){
(a[i_13954] = reagent.impl.template.as_element((a[i_13954])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7329__auto___13956 = a.length;
var i_13957 = (0);
while(true){
if((i_13957 < n__7329__auto___13956)){
var val_13958 = (a[i_13957]);
if((cljs.core.vector_QMARK_(val_13958)) && ((reagent.impl.template.key_from_vec(val_13958) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13957] = reagent.impl.template.as_element(val_13958));
...
var ctx = ({});
var vec__13963 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13963,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13963,(1),null);
...
var G__13967 = (cljs.core.count(argv) - first_child);
switch (G__13967) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13967){
