...
if((i < len)){
var k = (ks[i]);
var G__13853 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__13854 = (i + (1));
m = G__13853;
i = G__13854;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13858 = c;
var G__13858__$1 = (((G__13858 == null))?null:G__13858.prototype);
if((G__13858__$1 == null)){
return null;
} else {
return (G__13858__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__13862 = c;
var G__13862__$1 = (((G__13862 == null))?null:G__13862.prototype);
if((G__13862__$1 == null)){
return null;
} else {
return (G__13862__$1["render"]);
}
})()));
});
...
return (function() { 
var G__13868__delegate = function (args){
var G__13866 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13866) : reagent.impl.component.as_element.call(null,G__13866));
};
...
while (G__13869__i < G__13869__a.length) {G__13869__a[G__13869__i] = arguments[G__13869__i + 0]; ++G__13869__i;}
  args = new cljs.core.IndexedSeq(G__13869__a,0);
} 
return G__13868__delegate.call(this,args);};
G__13868.cljs$lang$maxFixedArity = 0;
G__13868.cljs$lang$applyTo = (function (arglist__13870){
var args = cljs.core.seq(arglist__13870);
return G__13868__delegate(args);
});
...
var _STAR_current_component_STAR_13873 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_13873;
}});
...
var G__13881 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__13881) {
...
var c = this;
var G__13884 = reagent.impl.component.state_atom(c);
var G__13885 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13884,G__13885) : cljs.core.reset_BANG_.call(null,G__13884,G__13885));
});
;})(G__13881))
...
var or__6414__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__13887_13889 = (c["cljsRatom"]);
if((G__13887_13889 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13887_13889);
}
...
if(cljs.core.truth_((function (){var and__6402__auto__ = wrap;
...
var renders_13892 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_13893 = cljs.core.first(cljs.core.vals(renders_13892));
if((cljs.core.count(renders_13892) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_13892))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_13893)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_13893], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__6414__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6414__auto__)){
return or__6414__auto__;
} else {
...
var render_fun__$1 = (function (){var or__6414__auto__ = render_fun;
if(cljs.core.truth_(or__6414__auto__)){
return or__6414__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__6414__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__6414__auto__)){
return or__6414__auto__;
} else {
...
var name__$1 = (function (){var G__13891 = name;
switch (G__13891) {
case "":
...
var elem = (function (){var G__13902 = (function (){var or__6414__auto__ = (function (){var G__13904 = c;
if((G__13904 == null)){
return null;
} else {
return (G__13904["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6414__auto__)){
return or__6414__auto__;
...
return (G__13902["_currentElement"]);
}
})();
var name = (function (){var G__13905 = elem;
var G__13905__$1 = (((G__13905 == null))?null:(G__13905["type"]));
if((G__13905__$1 == null)){
return null;
} else {
return (G__13905__$1["displayName"]);
}
})();
var path = (function (){var G__13906 = elem;
var G__13906__$1 = (((G__13906 == null))?null:(G__13906["_owner"]));
var G__13906__$2 = (((G__13906__$1 == null))?null:reagent$impl$component$component_path(G__13906__$1));
if((G__13906__$2 == null)){
return null;
} else {
return [cljs.core.str(G__13906__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6414__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6414__auto__)){
return or__6414__auto__;
} else {
var G__13908 = c;
var G__13908__$1 = (((G__13908 == null))?null:G__13908.constructor);
if((G__13908__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__13908__$1);
}
}
})();
