...
var len__27062__auto___28737 = arguments.length;
var i__27063__auto___28738 = (0);
while(true){
if((i__27063__auto___28738 < len__27062__auto___28737)){
args__27069__auto__.push((arguments[i__27063__auto___28738]));

var G__28739 = (i__27063__auto___28738 + (1));
i__27063__auto___28738 = G__28739;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__27070__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq28736){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28736));
});
/**
...
var G__28742 = cljs.core.reduce.call(null,((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__28740_SHARP_,p1__28740_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__28743 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__4655__auto__){
return (function (p1__28741_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__28741_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__28742;
state = G__28743;
...
var G__28744 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),(cljs.core.truth_(escape_QMARK_)?cljs.core.seq.call(null,markdown.common.escape_code.call(null,clojure.string.join.call(null,buf))):buf),cljs.core.seq.call(null,close)));
var G__28745 = cljs.core.PersistentVector.EMPTY;
var G__28746 = cljs.core.rest.call(null,tokens);
var G__28747 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__28744;
buf = G__28745;
tokens = G__28746;
cur_state = G__28747;
...
var G__28748 = out;
var G__28749 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__28750 = cljs.core.rest.call(null,tokens);
var G__28751 = cur_state;
out = G__28748;
buf = G__28749;
tokens = G__28750;
cur_state = G__28751;
...
var G__28752 = out;
var G__28753 = buf;
var G__28754 = cljs.core.rest.call(null,tokens);
var G__28755 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__28752;
buf = G__28753;
tokens = G__28754;
cur_state = G__28755;
...
var G__28756 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__28757 = buf;
var G__28758 = cljs.core.rest.call(null,tokens);
var G__28759 = cur_state;
out = G__28756;
buf = G__28757;
tokens = G__28758;
cur_state = G__28759;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__28760_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__28760_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__28761_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__28761_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__28761_SHARP_));
