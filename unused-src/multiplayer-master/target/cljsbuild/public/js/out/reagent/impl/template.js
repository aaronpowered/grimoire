...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__26602__auto__,writer__26603__auto__,opt__26604__auto__){
return cljs.core._write.call(null,writer__26603__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__26004__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__26004__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__26004__auto__)){
return or__26004__auto__;
} else {
...
var G__27492 = o;
(G__27492[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__27493__delegate = function (args){
...
while (G__27494__i < G__27494__a.length) {G__27494__a[G__27494__i] = arguments[G__27494__i + 0]; ++G__27494__i;}
  args = new cljs.core.IndexedSeq(G__27494__a,0);
} 
return G__27493__delegate.call(this,args);};
...
return G__27493__delegate(args);
});
...
var old_27496 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_27496))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_27496)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__25992__auto__ = (node === document.activeElement);
if(and__25992__auto__){
var and__25992__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__25992__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__27499 = jsprops;
(G__27499["defaultValue"] = value);

(G__27499["onChange"] = ((function (G__27499,v,value,on_change){
return (function (p1__27497_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27497_SHARP_);
});})(G__27499,v,value,on_change))
);
...
var vec__27501 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27501,(0),null);
var id = cljs.core.nth.call(null,vec__27501,(1),null);
var class$ = cljs.core.nth.call(null,vec__27501,(2),null);
...
var temp__4659__auto__ = (function (){var G__27505 = cljs.core.meta.call(null,v);
if((G__27505 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__27505);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__27507_27508 = v;
var G__27507_27509__$1 = (((G__27507_27508 == null))?null:reagent.impl.template.key_from_vec.call(null,G__27507_27508));
if((G__27507_27509__$1 == null)){
} else {
(jsprops["key"] = G__27507_27509__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__27512 = cljs.core.meta.call(null,argv);
if((G__27512 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__27512);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__27513 = (((jsprops == null))?{}:jsprops);
(G__27513["key"] = key);
...
var G__27514 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27514;
continue;
}
} else {
...
var n__26907__auto___27515 = a.length;
var i_27516 = (0);
while(true){
if((i_27516 < n__26907__auto___27515)){
(a[i_27516] = reagent.impl.template.as_element.call(null,(a[i_27516])));

var G__27517 = (i_27516 + (1));
i_27516 = G__27517;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26907__auto___27518 = a.length;
var i_27519 = (0);
while(true){
if((i_27519 < n__26907__auto___27518)){
var val_27520 = (a[i_27519]);
if((cljs.core.vector_QMARK_.call(null,val_27520)) && ((reagent.impl.template.key_from_vec.call(null,val_27520) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27519] = reagent.impl.template.as_element.call(null,val_27520));
...
if(cljs.core.truth_((function (){var and__25992__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__25992__auto__){
return (ctx["no-key"]);
} else {
return and__25992__auto__;
...
var G__27523 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27523) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27523){
