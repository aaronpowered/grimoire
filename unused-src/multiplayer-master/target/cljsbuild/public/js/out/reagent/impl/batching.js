...
var or__26004__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__26004__auto__)){
return or__26004__auto__;
} else {
var or__26004__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__26004__auto____$1)){
return or__26004__auto____$1;
} else {
var or__26004__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__26004__auto____$2)){
return or__26004__auto____$2;
} else {
var or__26004__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__26004__auto____$3)){
return or__26004__auto____$3;
} else {
...
var n__26907__auto__ = a.length;
var i = (0);
while(true){
if((i < n__26907__auto__)){
var c_27428 = (a[i]);
if(cljs.core.truth_((c_27428["cljsIsDirty"]))){
(c_27428["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__26602__auto__,writer__26603__auto__,opt__26604__auto__){
return cljs.core._write.call(null,writer__26603__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__27432 = c;
var G__27432__$1 = (((G__27432 == null))?null:(G__27432["props"]));
if((G__27432__$1 == null)){
return null;
} else {
return (G__27432__$1["argv"]);
}
});
...
var G__27434_27435 = (c["cljsRatom"]);
if((G__27434_27435 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__27434_27435);
}
