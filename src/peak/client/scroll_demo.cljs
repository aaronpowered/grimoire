(ns peak.client.scroll-demo
  (:require-macros [cljs.core.async.macros :refer [go-loop]])
  (:require [reagent.core :as r]
            [cljs.core.async :refer [<!]]
            [goog.events :as events]
            [cljsjs.react :as react]
            [peak.client.utils.fps :refer [fps]]
            [peak.client.utils.scroll-chan :refer [scroll-chan-events scroll-chan-test]]
            [peak.client.utils.scroll-engine :refer [animation-container]]))
